		...
		<div class="carousel-inner">
			<@ foreach in filelist @>
				...
				<div class="carousel-item<@ active @>" style="position: relative; text-align: center;">
					...
					alt="@{ :basename }"
					>
					<div class="header-hero-body" style="justify-content:center; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
					<h1><img src="assets/img/mcf_logo_banner_rgb.svg" style="width:300px;height:90px;" alt="Mid-Canada Fasteners &amp; Tools Ltd."></h1>
					<h2 class="subheader"><em>@{ text_Subheader }</em></h2>
					<a class="button" href="https://midcanadafasteners.shop">Shop Online</a>
					<a class="button hollow" href="specials.php">View Specials</a>
					</div>
